...
/* One of each list has to be present. Workstream B made the guest home
   the landing page out of season and NowSeason in it, so each list is a
   pair again: the landing's sentence first, the week's second. The old sentences are retired by design, not lost:
...
const SEASONAL = [
  ...
  ["Every call,", "Bring your league."],
  // The supporting line: the claim the whole product makes.
  ["the player your league would start instead", "who to start, who to claim, whether a trade is fair"],
  // The primary call to action.
  ["Run a free mock draft", "Connect your league"],
];
